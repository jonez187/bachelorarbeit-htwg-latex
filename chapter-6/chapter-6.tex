...
sehr gut, andere nur eingeschränkt durch Gewicht, Stromverbrauch und  
...
Nach der Konvertierung der PDFs in strukturierte Markdown-Segmente wurden 
die Inhalte schema-gesteuert in JSON extrahiert.
...
Lebensdauer aggregierter Stromverbrauch, sowie PCA-verdichtete Materialinformationen.
...
\emph{Climate change (total)}. Gewicht, Stromverbrauch über die Lebensdauer und
...
\emph{Eutrophication (terrestrial)}, \emph{Ozone depletion} und
...
Die stark rechtsschiefen Verteilungen der Inputgrößen und Indikatoren unterstreichen, 
dass Transformationen für eine stabilere Modellierung hilfreich sind..
...
Stromerzeugung über die Zeit verändern. Dadurch entsteht eine zusätzliche,
...
nicht zu vollständig normalverteilten Residuen. Damit sind klassische
...
Die Materialmodellierung ist ebenfalls mit einer Abwägung verbunden. Die
