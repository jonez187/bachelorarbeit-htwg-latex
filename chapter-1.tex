...
und Diskussion der Ergebnisse reicht. Die Arbeit ist in sechs Kapitel gegliedert.
...
Kapitel~\ref{chapter:discussion} diskutiert die Ergebnisse im Hinblick auf praktische Aussagekraft, Fehlermuster und
Modellannahmen. Zudem werden Grenzen der Übertragbarkeit, der Einfluss von Datenheterogenität
sowie mögliche Bias-Quellen reflektiert.

Kapitel~\ref{chapter:fazit} fasst das methodische Vorgehen und die wichtigsten Ergebnisse zusammen und gibt
einen Ausblick auf Weiterentwicklungen der Pipeline, zusätzliche Merkmale und möglichen
