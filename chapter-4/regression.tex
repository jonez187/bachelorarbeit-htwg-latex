...
Das Modell wird ausschließlich durch weitere Aufteilungen der 90\% Trainingsdaten 
...
Der Median der absoluten Fehler liegt bei $2220.80\,\mathrm{kg}$ und beschreibt die
typische absolute Abweichung eines repräsentativen Produkts.
Der Median der relativen Fehler liegt bei $51.49\%$.
Der Mittelwert des relativen Fehlers beträgt $120.27\%$ und fällt deutlich höher aus,
...
\begin{figure}[ht]
  ...
  \caption{Vorhergesagte und tatsächliche Werte von \texttt{Climate Change total} für einen
           exemplarischen Train und Test Split des CO$_2$-Modells.}
...
Eine genannte Annahme der linearen Regression ist, dass die Schätzfehler des Modells
näherungsweise normalverteilt sind.

Abbildung~\ref{fig:regression_co2_qq_orig} zeigt einen QQ Plot der Schätzfehler auf der 
...
und Fehler häufig multiplikativ wirken, was auf Originalskala zu stark asymmetrischen Schätzfehler führt.

\begin{figure}[ht]
  \centering
  \includegraphics[width=0.95\textwidth]{images/regression_co2_qq_orig.png}
  \caption{QQ Plot der Schätzfehler des CO$_2$-Modells auf Originalskala im Testset.}
  \label{fig:regression_co2_qq_orig}
\end{figure}

Abbildung~\ref{fig:regression_co2_qq_trans} zeigt den QQ Plot der Schätzfehler auf der Transformationsskala.
...
\begin{figure}[ht]
  ...
  \caption{QQ Plot der Schätzfehler des CO$_2$-Modells im Testset auf der Transformationsskala \texttt{log\_cc}.}
