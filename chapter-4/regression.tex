...
Wichtig ist, dass die Materialanteile selbst nicht log transformiert werden.
...
Eine weitere Auswertung der größten Abweichungen zeigt, dass diese vor allem bei
...
(z.\,B.\ Cluster bei $10^3,\mathrm{kg}$) werden.
...
\begin{figure}[h]
  ...
  \caption{QQ Plot der Residuen des CO$_2$-Modells auf Originalskala im Testset.}
...
\begin{figure}[h]
  ...
  \caption{QQ Plot der Residuen des CO$_2$-Modells im Testset auf der Transformationsskala \texttt{log\_cc}.}
