...
grafisch untersucht. Die Histogramme, von welchen die drei häufigsten Materialien 
...
verwendet. Dieser zentriert jede Materialspalte um den Median und skaliert durch den
IQR, wobei die Quantile standardmäßig als
...
Die PCA wird anschließend auf den robust skalierten Materialien durchgeführt.
...
\begin{figure}[h]
  ...
  \caption{Histogramme der Materialien mit den größten Anteilen über alle Produkte. [Eigene Darstellung]}
...
\begin{figure}[H]
  ...
  \caption{Kumulative erklärte Varianz. [Eigene Darstellung]}
  \label{fig:pca_kum}
\end{figure}
...
und Materialien wie Papier in den ersten
