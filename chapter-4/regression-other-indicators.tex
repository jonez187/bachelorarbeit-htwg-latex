...
für die einzelnen Indikatoren sind in Anhang~\ref{app:regression_plots} dargestellt.
...
\begin{table}[ht]
  ...
  \begin{tabular}{lccccccc}
    ...
    Water use & 169 & Box-Cox & 0.726 & 28682.36 & 1353.5625 & 0.9297 & 2.3278 \\
    ...
    Ozone depletion & 170 & Box-Cox & 0.858 & 0.0029 & 0.0000 & 0.8635 & 1.0411 \\
    Resource use, minerals and metals & 175 & Box-Cox & 0.866 & 0.7218 & 0.0010 & 0.7798 & 1.0003 \\
    \bottomrule
  \end{tabular}
  }
\end{table}
...
Anhang~\ref{app:regression_plots} dokumentiert.
...
Für diese schwächer er\-klär\-ba\-ren Ziel\-größen wurden ebenfalls verschiedene
Trans\-for\-mationen der Zielvariable verglichen. Box-Cox kann die Testgüte für alle 
...
Abbildung~\ref{fig:reg_rwd} zeigt
den Indikator \emph{Radioactive Waste Disposed} als besonders kritisches Beispiel. 
Obwohl die absoluten Fehler aufgrund
...
aufgezählten Indikatoren. Die zugehörigen Scatter- und QQ-Plots sind ebenfalls im
Anhang~\ref{app:regression_plots} dokumentiert.
