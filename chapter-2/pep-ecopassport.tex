...
Die Datenquelle dieser Arbeit bilden die 
\emph{PEP-Ecopassports}, 
welche ausschließlich im PDF-Format vorliegen. 
In diesem Kapitel werden die Standards, Inhalte und Strukturen dieser Dokumente beschrieben,
...
elek\-tro\-nische so\-wie Hei\-zungs-, Lüf\-tungs-, Klima- und Kälteprodukte (HVAC). 
...
\begin{itemize}
    ...
    \item \textbf{Optionale Phase (D)}: Rückgewinnung und Wiederverwendung außerhalb der Systemgrenzen.
\end{itemize}
...
Die Umweltwirkungen werden für jede Lebenszyklusphase und als Gesamtwert angegeben.  
...
die eingesetzte Software (z.\,B.\ SimaPro~9.3 mit Ecoinvent~3.8), die Verifizierungsstelle
