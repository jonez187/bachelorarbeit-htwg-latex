...
Dieser Prozess bildet die Grundlage für die weitere Verarbeitung,
...
In \cite{Lovegrove1995} wird das PDF-Format als ein weit verbreitetes, primär layoutbasiertes
Dokumentenformat beschrieben. Das Format enthält die Platzierung und Darstellung von Textobjekten
...
Nach \cite{Bast2017} und \cite{Chao2004} fehlt dem PDF-Format allerdings eine
...
Extraktionsansätze, um PDF-Dateien in ein strukturiertes Format zu bringen,
...
Mehrere weit verbreitete Softwarebibliotheken implementieren regelbasierte Parser, 
...
\emph{GROBID} \cite{grobid} und \emph{Docling}. 
...
Ein auf \emph{DocLayNet} trainiertes Layoutmodell ist Teil dieser 
Pipeline und detektiert Seitenelemente wie Absätze,
...
als Standard für strukturierten Datenaustausch etabliert hat.
JSON bildet Daten über einfache Typen und hierarchische Strukturen wie
Objekte und Arrays ab und eignet sich damit für verschachtelte Informationen \cite{Pezoa2016}. 
In dieser Arbeit dient JSON als einheitliche Repräsentation
der extrahierten PEP-Daten und ermöglicht eine reproduzierbare Weiterverarbeitung
in Analyseumgebungen wie Python oder R.
...
oder Feature-Sets ist mit erheblichem Aufwand verbunden.
